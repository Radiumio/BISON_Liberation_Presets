...
heavy_vehicles = [
    ...
    ["APC_Wheeled_01_atgm_base_lxWS",220,100,125],                      // AMV-7 Marshall (ATGM) Westen Sahara
    ["APC_Wheeled_01_command_base_lxWS",180,50,100],                    // AMV-7 Marshall (CV) Western Sahara
    ["APC_Wheeled_01_mortar_base_lxWS",250,150,125],                    // AMV-7 Marshall (Mortar) Western Sahara
...
support_vehicles = [
    ...
    ["Box_NATO_AmmoVeh_F",50,100,0],                                    // Vehicle Ammo [NATO]
