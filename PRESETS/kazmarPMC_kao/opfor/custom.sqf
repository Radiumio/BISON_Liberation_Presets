...
opfor_sentry = "O_INTKAZMAR_TF_Horizon_Agent_URB_01";                 // TF Horizon Agent                        
...
opfor_heavygunner = "O_INTKAZMAR_TF_Horizon_Machinegunner_URB_01";    // TF Horizon Machinegunner                           
...
opfor_engineer = "O_INTKAZMAR_TF_Horizon_Agent_URB_01";               // TF Horizon Agent                            
