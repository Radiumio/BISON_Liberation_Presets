...
Respawn_truck_typename = ["XDF_HEMTT_Medical","XDF_Cyclone_Medical","XDF_Medusa_Medical_Pod","XDF_Skyhawk","XDF_Dragonfly","XDF_Dragonfly_Pylons","XDF_Mamba_Unarmed","XDF_Mamba","XDF_AAV9_Barracuda","XDF_AAV9_50mm_Barracuda","XDF_Achelois_Unarmed","XDF_Achelois_HMG","XDF_Achelois_ATGM","XDF_Van_Ambulance","XDF_Serval"];
...
light_vehicles = [
    ...
    ["XDF_Serval",0,0,0],
    ["XDF_Serval_HMG",0,0,0],
    ["XDF_Serval_IFV",50,80,25],
    ["XDF_Serval_AA",50,80,25],
    ["XDF_Serval_Mortar",50,90,25],
...
air_vehicles = [
    ...
    ["XDF_Eagle",150,130,60],
    ["XDF_Eagle_Stealth",150,130,60],
