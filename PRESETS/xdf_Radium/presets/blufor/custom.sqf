...
Respawn_truck_typename = ["XDF_Skyhawk","XDF_HEMTT_Medical","XDF_Cyclone_Medical","XDF_Medusa_Medical_Pod","XDF_Dragonfly","XDF_Dragonfly_Pylons","XDF_Mamba_Unarmed","XDF_AAV9_Barracuda","XDF_AAV9_50mm_Barracuda","XDF_Achelois_Unarmed","XDF_Achelois_HMG","XDF_Achelois_ATGM","XDF_Van_Ambulance"];
