/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// THIS PART OF CODE INCLUDES THE CARGO CONFIGURATION AND POSITIONS FOR CUSTOM VEHICLES IN BLACK TALON!                //
// Although these vehicles are already existent in other mods and apart of the config, the nature of custom classnames //
// means that they will still not work. The Liberation Config has been updated to reflect this. This code should       //
// **REPLACE** the KPLIB_transportConfigs array                                                                        //
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
KPLIB_transportConfigs = [
    ...
    ["XDF_Skyhawk", -8, [0,2.2,-1], [0,0.5,-1], [0,-1.2,-1]],
    ["B_T_Truck_01_cargo_F", -6.5, [0,-0.4,0.4], [0,-2.1,0.4], [0,-3.8,0.4]],
    ["XDF_HEMTT_Cargo", -6.5, [0,-0.4,0.4], [0,-2.1,0.4], [0,-3.8,0.4]],
    ["B_T_Truck_01_covered_F", -6.5, [0,-0.4,0.4], [0,-2.1,0.4], [0,-3.8,0.4]],
    ["XDF_HEMTT_Transport_Covered", -6.5, [0,-0.4,0.4], [0,-2.1,0.4], [0,-3.8,0.4]],
    ["B_T_Truck_01_flatbed_F", -6.5, [0,-0.4,0.4], [0,-2.1,0.4], [0,-3.8,0.4]],
    ["XDF_HEMTT_Flatbed", -6.5, [0,-0.4,0.4], [0,-2.1,0.4], [0,-3.8,0.4]],
    ["B_T_Truck_01_transport_F", -6.5, [0,-0.4,0.4], [0,-2.1,0.4], [0,-3.8,0.4]],
    ["XDF_HEMTT_Transport", -6.5, [0,-0.4,0.4], [0,-2.1,0.4], [0,-3.8,0.4]],
    ...
    ["XDF_Albatross_IT", -7.5,[0,4.7,-4.88],[0,3,-4.88],[0,1.3,-4.88],[0,-0.4,-4.88],[0,-2.1,-4.88]],
    ["XDF_Albatross_VT", -7.5,[0,4.7,-4.88],[0,3,-4.88],[0,1.3,-4.88],[0,-0.4,-4.88],[0,-2.1,-4.88]],
    ...
    ["XDF_Offroad_Covered", -6.5, [0,-1.7,0.4]],
    ["XDF_Offroad_Comms", -6.5, [0,-1.7,0.4]],
    ...
    ["XDF_Cyclone_Covered", -6.5, [0,-0.8,0.4], [0,-2.4,0.4], [0,-4.0,0.4]],
    ["XDF_Cyclone", -6.5, [0,-0.8,0.4], [0,-2.4,0.4], [0,-4.0,0.4]],
